export default {
    settings: {
      ...
      payment: {
        ...
        field_successUrl: '支付成功跳转地址',
        field_cancelUrl: '取消支付跳转地址',
        ...
        field_wooshpayApiBaseHint: '请选择与密钥匹配的环境：测试密钥使用 apitest，生产密钥使用 api。',
        field_wooshpayReturnUrlHint: '可选。留空时使用每个订单自动生成的支付结果页地址。',
        ...
        wooshpayWebhookHint: '请在 WooshPay 后台将以下地址配置为 Webhook 端点，并订阅 payment_intent.succeeded：',
