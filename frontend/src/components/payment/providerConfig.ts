...
export const METHOD_ORDER = ['alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex', 'wooshpay'] as const
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  wooshpay: '/api/v1/payment/webhook/wooshpay',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  wooshpay: { notifyUrl: WEBHOOK_PATHS.wooshpay, returnUrl: RETURN_PATH },
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  wooshpay: [
    ...
    { key: 'webhookSecret', label: '', sensitive: true },
    {
      ...
      label: '',
      sensitive: false,
      defaultValue: 'https://api.wooshpay.com',
      hintKey: 'admin.settings.payment.field_wooshpayApiBaseHint',
      options: [
        { value: 'https://apitest.wooshpay.com', label: 'Test — apitest.wooshpay.com' },
        { value: 'https://api.wooshpay.com', label: 'Live — api.wooshpay.com' },
      ],
    },
    { key: 'successUrl', label: '', sensitive: false, optional: true, hintKey: 'admin.settings.payment.field_wooshpayReturnUrlHint' },
    { key: 'cancelUrl', label: '', sensitive: false, optional: true, hintKey: 'admin.settings.payment.field_wooshpayReturnUrlHint' },
    { key: 'currency', label: '', sensitive: false, defaultValue: 'CNY', options: [{ value: 'CNY', label: 'CNY' }] },
  ],
}
